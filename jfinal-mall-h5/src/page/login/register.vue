<template>
  <div>
    ...
    <div class="fromSubmint">
      ...
      <!-- 验证码 -->
      <van-cell-group>
        <van-field v-model="from.smsCode" @input="change" center clearable placeholder="请输入短信验证码">
          <van-button
            slot="button"
            size="small"
            :disabled="smsactive"
      ...
      <van-cell-group>
        <van-field
          v-model="from.firstLeaderMobile"
          clearable
          type="number"
          @input="change"
  ...
  mounted() {
    if (sessionStorage.getItem("userId") && sessionStorage.getItem("token")) {
      ...
      if (this.$route.query.mobile) {
        this.from.firstLeaderMobile = this.$route.query.mobile;
      }
    }
  }
};
