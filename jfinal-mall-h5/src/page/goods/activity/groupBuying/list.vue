            ...
            >
              ...
              <div class="card_fight">
                ...
                <div class="card_fight_bottom">
                  <div>{{items.specName}}</div>
                  <div>x{{items.goodNum}}</div>
                </div>
                <div class="card_fight_bottom">
                  <div class="card_fight_bottom_icon">
                    <span>10人成团</span> 还差9人成团
                  </div>
                </div>
              </div>
            </div>
            ...
            <div slot="footer">
              <div class="shop_cost">
                ...
                <div>
                  ...
                  <span class="money">￥{{item.orderAmount}}</span>
...
import { OrderList, RemindGoods, Cancel, Confirm } from "../../../../../api/";
export default {
  components: {
    Navbar,
    ShopCard
